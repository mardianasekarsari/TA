...
import com.example.mardiana.alertsystemrumahpompa.NotificationUtils;
import com.example.mardiana.alertsystemrumahpompa.PetugasHomeActivity;
...
/**
 * Created by Mardiana on 3/30/2017.
 */
    ...
    private void handleDataMessage(JSONObject json) {
        ...
        try {
            ...
            if (!NotificationUtils.isAppIsInBackground(getApplicationContext())) {
                ...
                Intent resultIntent = new Intent(getApplicationContext(), PetugasHomeActivity.class);
