...
public class PengawasHomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pengawas_home);
        ...
        ((TextView) findViewById(R.id.main_toolbar_title)).setText("Pengawas");
